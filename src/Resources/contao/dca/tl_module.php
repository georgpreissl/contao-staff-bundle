 ...
 */
$GLOBALS['TL_DCA']['tl_module']['palettes']['staff_list']   = '{title_legend},name,headline,type;{config_legend},staff_archives;{redirect_legend},jumpTo;{protected_legend:hide},protected;{expert_legend:hide},guests,cssID,space';
$GLOBALS['TL_DCA']['tl_module']['palettes']['staff_reader'] = '{title_legend},name,headline,type;{protected_legend:hide},protected;{expert_legend:hide},guests,cssID,space';
