 ...
 * Back end modules
 */
$GLOBALS['TL_LANG']['MOD']['staff'] = array('Mitarbeiter', 'Mitarbeiter verwalten');


/**
 * Front end modules
 */
$GLOBALS['TL_LANG']['FMD']['stafflist']   = array('Mitarbeiterliste', 'Fügt der Seite eine Mitarbeiterliste hinzu');
$GLOBALS['TL_LANG']['FMD']['staffreader'] = array('Mitarbeiterleser', 'Stellt einen einzelnen Mitarbeiter dar');
